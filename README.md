...
```
  python3 app.py -i "images/blue-car.jpg" -t "CAR_META" -m "intel/vehicle-attributes-recognition-barrier-0039/INT8/vehicle-attributes-recognition-barrier-0039.xml" -c "/opt/intel/openvino/deployment_tools/inference_engine/lib/intel64/libcpu_extension_sse4.so"
  python3 app.py -i "images/sign.jpg" -t "TEXT" -m "intel/text-detection-0004/FP16/text-detection-0004.xml" -c "/opt/intel/openvino/deployment_tools/inference_engine/lib/intel64/libcpu_extension_sse4.so"
  python3 app.py -i "images/sitting-on-car.jpg" -t "POSE" -m "intel/human-pose-estimation-0001/FP32/human-pose-estimation-0001.xml" -c "/opt/intel/openvino/deployment_tools/inference_engine/lib/intel64/libcpu_extension_sse4.so"
```
